...
<html lang="en">
      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12">
            ...
            <p>Welcome to Contact Form Here you can see you custumers contact info</p>
          </div>
          <table class="table">
  <thead>
    <tr>
  ...
  <tbody>
    <?php
    // Fetch data from the contactform table
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo '<tr>';
        echo '<th scope="row">' . $sno . '</th>'; // Serial number
        ...
        $sno++; // Increment the serial number for each entry
    }
    ?>
  </tbody>
</table>
